...
/// declares. Shared case types are deliberately meaning-free (an arbitrary <c>Error</c>,
/// <c>Success</c>, or a dev's own shared record can be reused across unions to mean whatever that
/// union's author wants); classification lives on the union instead, one union at a time. Because
