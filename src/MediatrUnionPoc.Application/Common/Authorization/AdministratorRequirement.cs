...
{
    /// <summary>Initializes a new instance of the <see cref="AdministratorRequirement"/> class with the set of roles that satisfy it.</summary>
    ...
    /// <summary>Gets the roles that satisfy this requirement; matching any one of them is sufficient.</summary>
