...
/// a product has no ownership prerequisite. Defaults to <see langword="null"/>, which creates an
/// unowned product.
/// </param>
...
) : ITransactionalCommand<CreateProductResult>, IAuditableRequest<CreateProductResult>
{
    ...
    /// <inheritdoc/>
    /// <remarks>
    /// <para>The target is the id of the product the successful response carries; every other case created nothing, so it has none.</para>
    /// </remarks>
