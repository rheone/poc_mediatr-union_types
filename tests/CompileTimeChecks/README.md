...
`CS8509` build error, not just a convention or an analyzer suggestion. See the documentation's
[Exhaustiveness checking](../../docs/glossary.md#c-language-concepts) glossary entry if that term is new,
and [Shared case types are meaning-free](../../docs/case-types.md#shared-case-types-are-meaning-free-transactionbehavior-cant-assume-what-a-case-means)
